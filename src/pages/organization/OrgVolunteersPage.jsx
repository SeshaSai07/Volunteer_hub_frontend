...
import { getOpportunities } from '../../api/opportunityService'; // We'll add a new api call shortly
...
const OrgVolunteersPage = () => {
    ...
    const fetchLogs = async () => {
        setLoading(true);
        try {
            const res = await apiClient.get('/opportunities/org/volunteers');
            setLogs(res.data);
        } catch {
    ...
    const handleSave = async () => {
        ...
        setSaving(true);
        try {
            await apiClient.put(`/opportunities/org/volunteers/${editing.id}`, { status: editing.status, hours_logged: editing.hours_logged });
    ...
    return (
        <div className="page-container">
            ...
            <div style={{ display: 'flex', gap: '1rem', alignItems: 'center', marginBottom: '1.5rem', flexWrap: 'wrap' }}>
                <Link to="/profile" className="btn btn-secondary"><ArrowLeft size={14} /></Link>
                <h1 className="section-title" style={{ marginBottom: 0 }}>My <span>Volunteers</span></h1>
...
export default OrgVolunteersPage;
